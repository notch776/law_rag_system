...
冲突处理硬约束：当槽位与历史记忆存在冲突时，只能采用槽位中的最新事实，不得在回答中暴露、复述或强调历史冲突，不得输出“会话记录中存在差异”“历史信息不一致”“1%与12%表述差异”“无法确定持股比例”等不确定表述；除非槽位本身为空或缺失，才提示需要补充事实。
...
冲突处理硬约束：当槽位与压缩记忆存在冲突时，只能采用槽位中的最新事实，不得在初答中输出“会话记录中存在差异”“历史信息不一致”“1%与12%表述差异”“无法确定持股比例”等不确定表述；除非槽位本身为空或缺失，才提示需要补充事实。
